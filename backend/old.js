...
// Load your private key and self-signed certificate
// const privateKey = fs.readFileSync('/etc/ssl/private/private_no_pass.key', 'utf8');
...
//   key: privateKey,
//   cert: certificate,
//   // ca: ca  // Uncomment this line if you're using a CA cert
// };
...
// Create a WebSocket server that listens on all network interfaces (0.0.0.0)
  ...
  app.post("/api/verify", async (req, res) => {
    ...
    let { orderId } = req.body;
      ...
      try {
        ...
        res.json(response.data); // Send payment verification response back to the client
      } catch (error) {
...
//   const options = {
//     key: fs.readFileSync('/etc/letsencrypt/live/selfi.eyelikesystems.com/privkey.pem'),
//     cert: fs.readFileSync('/etc/letsencrypt/live/selfi.eyelikesystems.com/fullchain.pem'),
//     ca: fs.readFileSync('/etc/letsencrypt/live/selfi.eyelikesystems.com/chain.pem'),  // If required
//   };
...
//   });
  ...
  // Start the server
  server.listen(8080, () => {
    console.log('Server running on https://selfi.eyelikesystems.com:8080');
  });
});
